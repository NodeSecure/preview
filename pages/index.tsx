    ...
    <div className="min-h-screen p-20 bg-gray-100">
      <div className="container mx-auto">
        <div className="p-10 relative flex flex-col items-center">
          <h1 className="uppercase mb-2 leading-relaxed text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-800 to-purple-500">node-scanner</h1>
          <p className="mb-8 text-4xl text-gray-400 font-thin font-sans">Let me tell reveal your pkg weakness?</p>
